<div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-white border-0">
        ...
        @else
            <h4 class="font-weight-bold mb-0">
                <i class="fas fa-concierge-bell text-info mr-2"></i>
                Service Information
            </h4>
        @endif
    </div>
        ...
        @if ($appointment->type === 'doctor')
            @if ($doctor)
                <div class="row align-items-center">
                    <div class="col-md-3 text-center mb-3 mb-md-0">
                        <img src="{{ asset($doctor->image ?: 'uploads/images/default.jpg') }}" alt="{{ $doctor->name }}"
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <strong class="text-success">৳ {{ number_format($doctor->consultation_fee ?? 0, 2) }}</strong>
                            </div>
                        </div>
                    </div>
                </div>
            @else
                <div class="alert alert-warning mb-0">
                    ...
                    Doctor information is no longer available.
                </div>
            @endif
        @else
            @if ($service)
                <div class="row align-items-center">
                    <div class="col-md-3 text-center mb-3 mb-md-0">
                        <img src="{{ asset($service->image ?: 'uploads/images/default.jpg') }}"
            ...
            @else
                <div class="alert alert-warning mb-0">
                    <i class="fas fa-exclamation-triangle mr-2"></i>
                    Service information is no longer available.
                </div>
            @endif
        @endif
    </div>
