            ...
            <div class="doctor-create-card">
                ...
                <form action="{{ route('doctors.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="doctor-create-body">
                        ...
                        @include('backend.doctor_page.partial_layout.create_page.part_1')

                        {{-- This is for doctor experience information --}}
                        @include('backend.doctor_page.partial_layout.create_page.part_2')

                        {{-- This is for doctor qualification information --}}
                        @include('backend.doctor_page.partial_layout.create_page.part_3')

                        {{-- This is for consultation information --}}
                        @include('backend.doctor_page.partial_layout.create_page.part_4')

                        {{-- This is for doctor account information --}}
                        @include('backend.doctor_page.partial_layout.create_page.part_5')

                        {{-- This is for doctor about information --}}
                        @include('backend.doctor_page.partial_layout.create_page.part_6')

                        {{-- This is for doctor image --}}
                        @include('backend.doctor_page.partial_layout.create_page.part_7')
                    </div>
