            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <div class="info-box bg-light border rounded">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">৳{{ number_format($payment->amount, 2) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="info-box bg-light border rounded">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Transaction ID</span>
                            <span class="info-box-number">{{ $payment->transaction_id }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="info-box bg-light border rounded">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"> {{ $payment->payment_method }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="info-box bg-light border rounded">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Card Ending</span>
                            <span class="info-box-number">**** {{ $payment->card_number }}</span>
                        </div>
                    </div>
                </div>
