...
@section('adminlte_css')
    <link rel="stylesheet" href="{{ asset('css/backend/setting_management/role/create_page/role_content_header.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/setting_management/role/create_page/role_information.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/setting_management/role/create_page/permission_header.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/setting_management/role/create_page/permission_manager.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/setting_management/role/create_page/permission_body.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/setting_management/role/create_page/permission_actions.css') }}">
@stop
...
@section('content_header')
    <div class="role-page-header">
        <div class="role-header-content">
            ...
            <div>
                <h1>Create Role</h1>
                <p>Create a new role and configure access permissions.</p>
            </div>
        </div>
