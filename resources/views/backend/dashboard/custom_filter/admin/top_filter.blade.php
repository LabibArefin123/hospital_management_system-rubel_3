<!-- FILTER SECTION -->
<div id="adminFilterSection" class="card d-none">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <small class="text-muted">Search and filter appointments quickly</small>
            </div>

            <button id="resetDashboardFilter" class="btn btn-danger btn-sm mt-2 mt-md-0">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-3">
                <label class="font-weight-bold">Search Appointment</label>
                <div class="input-group">
                    ...
                    <input type="text" id="dashboardSearch"
                        class="form-control"placeholder="Patient, doctor or service...">
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="searchPatient" class="form-control" placeholder="Patient">
                </div>
            </div>
        </div>
    </div>
