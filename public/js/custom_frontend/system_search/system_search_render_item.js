...
(function (window, $) {
    ...
    window.SystemSearch.createResultHtml = function (item) {
        ...
        if (item.type === "doctor") {
            return `
<a href="${window.SystemSearch.escapeAttribute(item.url || "#")}" class="system-search-result-item" data-result-type="doctor">
...
`;
        ...
        return `
        <div class="system-search-result-item" data-result-type="appointment">
        <span class="system-search-result-content">
        <span class="system-search-result-name">${name}</span>
        <span class="system-search-result-type">Appointment</span>
        <span class="system-search-result-meta">
        <span class="system-search-result-date"><i class="far fa-calendar-alt"></i>${date}</span>
        <span class="system-search-result-time"><i class="far fa-clock"></i>${time}</span>
        <span class="system-search-result-status ${statusClass}">${statusLabel}</span>
        </span>
        </span>
        </div>
        `;
